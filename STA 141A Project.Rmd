...
# Section 6 Further Discussions on choice of models
  ...
  One of the central purpose for this discussion was to find a trade-off between achieving a low misclassification rate and maintaining a balanced correct prediction rate for both 0s and 1s. As what was mentioned at the start of section 5, the way to address it, and the way I would choose the model, was to choose the one with highest average of correct_zeros_rate and correct_ones_rate. Since I found that the logistic model in model group 1 generates the highest value of such a ratio, I would choose that as my final model. 
...
# Github repo link: https://github.com/zcrnf/STA141A-COURSE-PROJECT.git
